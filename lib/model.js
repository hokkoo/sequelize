...
Model.prototype.refreshAttributes = function() {
  ...
  var prototypeAttributes = this.Instance.prototype.attributes = Object.keys(this.Instance.prototype.rawAttributes);

  this.Instance.prototype._isAttribute = Utils._.memoize(function(key) {
    return (self.Instance.prototype.attributes || prototypeAttributes).indexOf(key) !== -1;
  });
